...
export const frenchDashboard = {
  ...
  traffic: {
    ...
    series: {
      im: "Importation",
      in: "Intra-Canada",
      "in-w": "Intra-Canada ouest",
      "in-e": "Intra-Canada est",
      ex: "Exportation",
      cap: "Capacité",
      dh: "Lourd canadien",
      ...
      co: "Condensat",
      "ex-cap": "Capacité Exportation",
      "im-cap": "Capacité Importation",
      "in-e-cap": "Capacité intra-Canada Est",
      "in-w-cap": "Capacité intra-Canada Ouest",
  ...
  tolls: {
    ...
    dashboard: {
      ...
      filters: {
        ...
        path: "Choisir un parcours :",
        service: "Choisir un service :",
        units: selectUnits,
      },
      yAxis: "Droit",
      splitDescription: "Description des droits",
      pathDisclaimer: (thisPaths, totalPaths) =>
        `<p>Des parcours de droits de <strong>${thisPaths}</strong> sont indiqués pour ce réseau. Jetez un coup d’œil à l’ensemble de données du gouvernement ouvert pour obtenir de l’information sur tous les parcours de système disponibles de <strong>${totalPaths}</strong>.</p>`,
    },
  },
  tcplRevenues: {
    dateFormat,
