    ...
    ua: {
      ...
      dashboard: {
        ...
        source: {
          ...
          description:
            "The above map displays the location of DPR contravention reports that have been reported for the pipeline system over the past five plus years. The map defaults to show DPR contravention reports as bubbles which are coloured based on whether the pipe was damaged. DPR contravention reports on the map can be re-categorized based on whether there was a ground disturbance, the year, and who discovered the event. The DPR contravention reports data can also be toggled to display a stacked bar chart of events over time by clicking on the DPR Contravention Reports Trends button above the map. The stacked bars display the number of DPR contravention reports by year, with bar colour segments corresponding to the event type. Similar to the map, DPR contravention reports can be re-categorized by clicking on the side buttons to view a breakdown of events by whether pipe was damaged, who discovered the event, and method of discovery.",
          openGov: openGovLink(
            "https://open.canada.ca/data/en/dataset/43c4a4ea-6da8-4b02-8f07-986caafd9223",
            "en"
          ),
